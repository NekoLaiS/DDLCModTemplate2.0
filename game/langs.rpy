...
init -10 python:
    ...
    lang_dict["eng"] = GameLang(None, _("English"), False, "en")
    lang_dict["rus"] = GameLang("rus", _("Russian"), False, "ru") #Key sould be equal value.code (exp. English)
    ...
    if renpy.windows:
        ...
        import os
        lang = os.environ.get("LANG") or 'eng'
        lang = lang[:3]
